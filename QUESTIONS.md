...
- [`IDisposable`, Dispose pattern, `using`, `IAsyncDisposable`](./topics/language-platform/02-clr-gc-memory.md#q6)
- [Финализация, очередь финализации, `GC.SuppressFinalize`](./topics/language-platform/02-clr-gc-memory.md#q7)
