...
- [x] [Порождающие: Singleton, Factory, Builder, Prototype](#q1)
- [x] [Структурные: Adapter, Decorator, Facade, Proxy, Composite](#q2)
- [x] [Поведенческие: Strategy, Observer, Command, Mediator, Chain of Responsibility, State, Template Method](#q3)
- [x] [Корпоративные: Repository + UoW, DI, Options, Result, Specification](#q4)
