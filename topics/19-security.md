...
- [x] Аутентификация vs авторизация
- [x] Cookie vs token auth
- [x] JWT: структура, валидация
- [x] Access vs refresh token
- [x] OAuth 2.0 flows
- [x] OpenID Connect
- [x] IdentityServer/Keycloak/Entra
- [x] Authorization в ASP.NET Core
- [x] Где хранить токены
- [x] SQL injection, XSS, CSRF
...
- [x] Симметричное vs асимметричное, хеш vs шифрование
- [x] HTTPS/TLS
- [x] Supply-chain
