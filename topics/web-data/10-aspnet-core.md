...
- [x] [Generic Host / WebApplication](#q1)
- [x] [Middleware pipeline](#q2)
- [x] [DI и lifetimes, captive dependency](#q3)
- [x] [Жизненный цикл scope](#q4)
- [x] [Configuration и Options pattern](#q5)
- [x] [Controllers vs Minimal APIs](#q6)
- [x] [Model binding и валидация](#q7)
- [x] [Фильтры vs middleware](#q8)
- [x] [Routing](#q9)
- [x] [REST, статус-коды, версионирование](#q10)
- [x] [ProblemDetails](#q11)
- [x] [Глобальная обработка ошибок](#q12)
- [x] [HttpClientFactory, Polly](#q13)
- [x] [CORS, content negotiation](#q14)
- [x] [Health checks, BackgroundService](#q15)
- [x] [OpenAPI/Swagger](#q16)
