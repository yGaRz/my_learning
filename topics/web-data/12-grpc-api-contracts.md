...
- [x] [gRPC: основа HTTP/2 + Protobuf](#q1)
- [x] [4 типа вызовов](#q2)
- [x] [Почему gRPC быстрее REST/JSON](#q3)
- [x] [Версионирование protobuf](#q4)
- [x] [Deadlines, отмена, interceptors](#q5)
- [x] [gRPC-Web](#q6)
- [x] [gRPC vs REST — когда что](#q7)
- [x] [REST: уровни зрелости, идемпотентность, версионирование](#q8)
- [x] [GraphQL: когда, N+1, HotChocolate](#q12)
- [x] [Contract-first vs code-first](#q15)
- [x] [Совместимость, contract testing](#q16)
